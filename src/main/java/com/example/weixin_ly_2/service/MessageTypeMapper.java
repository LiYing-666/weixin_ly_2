package com.example.weixin_ly_2.service;


import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

import com.example.weixin_ly_2.domain.InMessage;
import com.example.weixin_ly_2.domain.image.ImageInMessage;
import com.example.weixin_ly_2.domain.text.TextInMessage;
